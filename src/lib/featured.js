// Curated, public-domain famous games shown on the landing page.
// Each PGN is fed through the same importer the "Import PGN" flow uses, so
// clicking one opens it straight in the engine-backed game viewer.
...
export const FEATURED_GAMES = [
  {
    ...
    year: 1858,
    result: '1-0',
    blurb: 'Morphy turns a night at the opera into a 17-move clinic on development and the open file.',
...
14. Rd1 Qe6 15. Bxd7+ Nxd7 16. Qb8+ Nxb8 17. Rd8# 1-0`,
  },
  {
    ...
    year: 1851,
    result: '1-0',
    blurb: 'Anderssen sacrifices a bishop, both rooks and the queen — then mates with three minor pieces.',
    pgn: `[Event "London"]
[Site "London ENG"]
[Date "1851.06.21"]
...
21. Nxg7+ Kd8 22. Qf6+ Nxf6 23. Be7# 1-0`,
  },
  {
    ...
    year: 1852,
    result: '1-0',
    blurb: 'A romantic-era gem finished off by a queen sacrifice and a quiet, deadly bishop.',
    pgn: `[Event "Berlin"]
[Site "Berlin GER"]
[Date "1852.??.??"]
[White "Adolf Anderssen"]
...
21. Qxd7+ Kxd7 22. Bf5+ Ke8 23. Bd7+ Kf8 24. Bxe7# 1-0`,
  },
  {
    ...
    year: 1956,
    result: '0-1',
    blurb: 'A 13-year-old Bobby Fischer unleashes a windmill and a queen sacrifice against a master.',
...
39. Kc1 Ne2+ 40. Kb1 Nc3+ 41. Kc1 Rc2# 0-1`,
  },
  {
    ...
    year: 1999,
    result: '1-0',
    blurb: 'A king dragged from a7 to d1 by one of the deepest attacking combinations ever played.',
...
38. Bxc4 bxc4 39. Qxh8 Rd3 40. Qa8 c3 41. Qa4+ Ke1 42. f4 f5 43. Kc1 Rd2 44. Qa7 1-0`,
  ...
  {
    id: 'deep-blue',
    title: 'Deep Blue beats the champion',
    players: 'Deep Blue vs. Kasparov, Game 6',
    year: 1997,
    result: '1-0',
    blurb: 'The match where a machine first beat a reigning world champion — a crisp knight sacrifice on e6.',
    pgn: `[Event "IBM Man-Machine, New York"]
[Site "New York, NY USA"]
[Date "1997.05.11"]
[White "Deep Blue"]
...
// Tactic themes spotlighted as one-tap puzzle launchers on the landing page.
// `key` matches the THEMES keys in lib/puzzles.js.
export const FEATURED_THEMES = [
  { key: 'mate', label: 'Checkmate', icon: '♛' },
  { key: 'fork', label: 'Forks', icon: '⑂' },
  { key: 'pin', label: 'Pins', icon: '📌' },
  { key: 'sacrifice', label: 'Sacrifices', icon: '🔥' },
  { key: 'backRankMate', label: 'Back-rank', icon: '⬇' },
